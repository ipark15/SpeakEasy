...
//#endregion
//#region node_modules/@elevenlabs/types/dist/src/types.js
/**
...
var BaseConversation = class {
	...
	async uploadFile(file) {
		const origin = (this.options.origin ?? HTTPS_API_ORIGIN$2).replace(/^wss:\/\//, "https://").replace(/^ws:\/\//, "http://");
...
//#endregion
//#region node_modules/@elevenlabs/client/dist/utils/mergeOptions.js
...
function deepMerge(...objects) {
	return objects.reduce((acc, obj) => {
		...
		for (const key of Object.keys(obj)) {
			...
			if (isPlainObject(accVal) && isPlainObject(objVal)) result[key] = deepMerge(accVal, objVal);
			else if (typeof accVal === "function" && typeof objVal === "function") result[key] = ((...args) => {
				accVal(...args);
				objVal(...args);
			});
			else if (objVal !== void 0) result[key] = objVal;
		}
		return result;
	}, {});
}
...
//#endregion
//#region node_modules/@elevenlabs/client/dist/utils/location.js
...
//#endregion
//#region node_modules/@elevenlabs/client/dist/utils/createWorkletModuleLoader.js
...
//#endregion
//#region node_modules/@elevenlabs/client/dist/utils/audioConcatProcessor.generated.js
...
`);
//#endregion
//#region node_modules/@elevenlabs/client/dist/utils/addLibsamplerateModule.js
...
//#endregion
//#region node_modules/@elevenlabs/client/dist/utils/output.js
...
//#endregion
//#region node_modules/@elevenlabs/client/dist/utils/rawAudioProcessor.generated.js
...
`);
//#endregion
//#region node_modules/@elevenlabs/client/dist/utils/compatibility.js
...
//#endregion
//#region node_modules/@elevenlabs/client/dist/utils/input.js
			...
			return function* () {
				...
				try {
					...
					if (!hasRetriedAfterNegotiationError && e instanceof NegotiationError) {
						_this2.log.warn("negotiation due to track publish failed, retrying after reconnect", Object.assign(Object.assign({}, _this2.logContext), { error: e }));
...
var Room = class Room extends eventsExports.EventEmitter {
	...
	*/
	...
	handleLocalTrackSubscribed(subscribedSid) {
		...
		this.log.debug("deferring LocalTrackSubscribed, publication not yet available", Object.assign(Object.assign({}, this.logContext), { subscribedSid }));
		...
		timer = setTimeout(() => {
			...
			else this.log.warn("could not find local track publication for LocalTrackSubscribed event after timeout", Object.assign(Object.assign({}, this.logContext), { subscribedSid }));
		}, TIMEOUT_MS);
	}
...
var EMPTY_FREQUENCY_DATA$1 = new Uint8Array(0);
...
var VoiceConversation = class VoiceConversation extends BaseConversation {
	...
	handleInterruption(event) {
		...
		if (!(interruptId !== void 0 && interruptId < this.currentEventId)) {
...
//#endregion
//#region node_modules/@elevenlabs/client/dist/utils/scribeAudioProcessor.generated.js
...
var Conversation = { startSession(options) {
...
function useScribe(options = {}) {
	...
	const [partialTranscript, setPartialTranscript] = (0, import_react.useState)("");
	const [committedTranscripts, setCommittedTranscripts] = (0, import_react.useState)([]);
	...
	const connect = (0, import_react.useCallback)(async (runtimeOptions = {}) => {
		...
		try {
			...
			if (microphone) connection = ScribeRealtime.connect({
				token,
				modelId,
			...
			else if (audioFormat && sampleRate) connection = ScribeRealtime.connect({
				token,
				modelId,
				baseUri: runtimeOptions.baseUri || defaultBaseUri,
				commitStrategy: runtimeOptions.commitStrategy || defaultCommitStrategy,
	...
	const sendAudio = (0, import_react.useCallback)((audioBase64, options) => {
	...
	const clearTranscripts = (0, import_react.useCallback)(() => {
		setCommittedTranscripts([]);
		setPartialTranscript("");
	}, []);
	const getConnection = (0, import_react.useCallback)(() => {
...
function ConversationFeedbackProvider({ children }) {
	...
	const sendFeedback = (0, import_react.useCallback)((like) => {
...
function useConversationClientTool(name, handler) {
	const registerClientTool = (0, import_react.useContext)(ConversationClientToolsContext);
...
function useStableCallbacks(props) {
	...
	return (0, import_react.useMemo)(() => Object.fromEntries(activeKeys.map((key) => [key, (...args) => {
...
//#endregion
export { AudioFormat, CommitStrategy, Conversation, ConversationProvider, RealtimeConnection, RealtimeEvents, ScribeRealtime as Scribe, SessionConnectionError, TextConversation, VoiceConversation, WebRTCConnection, WebSocketConnection, createConnection, postOverallFeedback, useConversation, useConversationClientTool, useConversationControls, useConversationFeedback, useConversationInput, useConversationMode, useConversationStatus, useRawConversation, useScribe };
